...
DEFAULT_CONTEXT = {
    ...
    'project_description': 'KPCC has created this searchable database that will allow you to compare the costs of the 100 most frequently billed procedures paid under Medicare in 2011, which you can view by hospital or as a statewide average. It\'s based on data released in May by the Centers for Medicare and Medicaid Services.',
    ...
    'project_headline': 'How much does medical care cost? A searchable database of procedures by hospital in California',
    ...
    # takes HTML. Will not render if blank
    'project_data_instructions': '<p><strong>To use this database</strong>: Let\'s say you wanted to compare the average statewide charge for treatment of kidney disease. To search the datanase, select "Kidney &amp; Urinary Tract" from the "Getting Started" menu, then choose from one of the diagnoses that match. Once you choose a category and a diagnosis, the data will show you charges and reimbursements in the state based on 1) overall average, 2) lowest and highest average cost and 3) difference. You can also compare the procedure between two hospitals to see how they compare on average charges and average reimbursement.</p>',
