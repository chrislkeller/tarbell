...
GOOGLE_DOC = {
    'key': '0Aq8qwSArzKP9dG11STlHdG10NDQyeENsUHpsX1pRZ0E',
}
...
DEFAULT_CONTEXT = {
    ...
    # project directory
    'project_name': 'proposition-8-sentiment',

    # used for page title and open graph descriptions
    'title': 'Your views on the Proposition 8 ruling',
    ...
    'project_headline': 'Xxxxxx xxxxx xxxxxxx xxxx',
...
"""
# URL_ROOT = 'proposition-8-sentiment'
...
# blueprint = Blueprint('proposition-8-sentiment', __name__)
