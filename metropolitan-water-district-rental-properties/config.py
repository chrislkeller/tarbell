...
GOOGLE_DOC = {
    'key': '0Aq8qwSArzKP9dEdtdERBamV4Smg0bi1DM25KUGRvbnc',
}
...
DEFAULT_CONTEXT = {
    ...
    # project directory
    'project_name': 'metropolitan-water-district-rental-properties',

    # used for page title and open graph descriptions
    'title': 'metropolitan-water-district-rental-properties',
